...
data = "grant_type=urn:ibm:params:oauth:grant-type:apikey&apikey=PCsDbo1D8R7Q6-0uCES-fP_l3VgS6BzUrYE4qHzdZ4kz"
...
def prediksi():
    #Get Prediction
    url = "https://us-south.ml.cloud.ibm.com/ml/v4/deployments/d10619d6-2048-4846-862a-3b9ecf0c3085/predictions?version=2021-05-01"
    headers = CaseInsensitiveDict()
